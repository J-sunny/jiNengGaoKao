...
export default {
  ...
  methods: {
    ...
    getList(currentPage, pageSize) {
      releaselistByReview({ currentPage: currentPage, pageSize: pageSize, examType: '1', subjectId: this.subjectId, releaseTime: this.releaseTime, keyword: this.keyword, releaseReviewStatus: this.state }).then(data => {
