      ...
      <div class="tizi">
        <el-row v-if="flag">
          <el-col v-if="tableDataTOP.length>1" class="jie" :span="8"><img src="../../../icons/png/t2.png" alt="">
            <div class="ztn">
              <p class="teksix" v-html="tableDataTOP[1].questionTitle" />
          ...
          <el-col v-if="tableDataTOP.length>0" class="jie zhong" :span="8"><img src="../../../icons/png/t1.png" alt="">
            <div class="ztn">
              <p class="teksix" v-html="tableDataTOP[0].questionTitle" />
          ...
          <el-col v-if="tableDataTOP.length>2" class="jie" :span="8"><img src="../../../icons/png/t3.png" alt="">
            <div class="ztn">
              <p class="teksix" v-html="tableDataTOP[2].questionTitle" />
...
<script>
import { statisticslistQuestion } from '@/api/Statistics'
...
export default {
  ...
  methods: {
    ...
    getListTOP() {
      this.flag = false
      statisticslistQuestion({ currentPage: 1, pageSize: 3, subjectId: this.subjectId }).then(data => {
        this.tableDataTOP = data.data.list
        this.flag = true
      })
    },
    getList() {
      statisticslistQuestion({ currentPage: this.currentPage, pageSize: this.pageSize, subjectId: this.subjectId }).then(data => {
